...
#%% FASHION MNIST
def loadDataset_FashionMnist(labels,train_percentage,shuffle_files,output_size,normalization, layer_type):
    ...
    Args:
      ...
      shuffle_files: Can be TRUE or FALSE
      output_size: It is a tuple of two integers that sets the desired height and width of the images.
      normalization: A linear normalization of the data is performed. It is a tuple that can be (-1,1) or (0,1).
      layer_type: Can be 'conv' or 'norm'. If the data are to be used as input to a normal morphological neural network, the tensors are resized so that they are (bach, (height-width)
...
#%% CIFAR 10
def loadDataset_Cifar10(labels,train_percentage,shuffle_files,output_size,normalization, layer_type):
...
#%% CIFAR 100 DATASET
def loadDataset_Cifar100(labels,train_percentage,shuffle_files,output_size,normalization, layer_type):
...
# IRIS DATASET
def loadDataset_Iris(labels,train_percentage,shuffle_files,output_size,normalization, layer_type):
...
def loadDataset_TicTacToe(train_percentage=90, test_percentage=10, shuffle_files=False, labels=""):
