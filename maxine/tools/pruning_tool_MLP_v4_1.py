...
def pruning_MLP(model, x_train, y_train, x_val, y_val, x_test, y_test, batch_size, morph_epochs=70, mlp_epochs=100, mlp_epochs_refit=50, p=20, ommit_layers=[], optimizer_config=None, extreme=False):
    """
