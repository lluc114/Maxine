...
def pruning_morphological(trained_model, x_train, y_train, x_val, y_val, x_test, y_test, surv_weights, batch_size, extreme=False, optimizer=None, metrics=None, loss=None):
    """
